...
def main():
    ...
    for i in range(0, 1000, 1):
        ...
        elif(f < 0.45):# if the car is angled to a higher degree than the waypoint
            if( s > 0.3 and s < 0.7):
                if(v < 0.6):
                    file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(f, s, v, k, noise(0.1, 0.1), noise(1.0, -0.1), noise(1.0, -0.1), noise(0.1, 0.1)))
                elif(v >= 0.6):
        ...
        elif(f > 0.55):# if the car is angled to a lower degree than the waypoint
            if( s > 0.3 and s < 0.7):
                if(v < 0.6):
                    file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(f, s, v, k, noise(1.0, -0.1), noise(0.1, 0.1), noise(1.0, -0.1), noise(0.1, 0.1)))
                elif(v >=0.6):
