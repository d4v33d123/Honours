                    ...
                    if( f >= 0.3 and f <= 0.7):
                        if(f >= 0.4 and f <= 0.6):#if the waypoint angle is centred
                            if( s > 0.4 and s < 0.6):#if the car is in the middle of the track
                                file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(noise(f, 0.1), noise(s, 0.1), noise(j, 0.1), noise(k, 0.1), noise(0.1, 0.1), noise(0.1, 0.1), noise(0.9, -0.1), noise(0.1, 0.1)))
                            elif(s <= 0.4 and s >= 0.2):# if the car is to the left of the track 
                                file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(noise(f, 0.1), noise(s, 0.1), noise(j, 0.1), noise(k, 0.1), noise(0.9, -0.1), noise(0.1, 0.1), noise(0.9, -0.1), noise(0.1, 0.1)))
                            elif(s < 0.2):
                                file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(noise(f, 0.1), noise(s, 0.1), noise(j, 0.1), noise(k, 0.1), noise(0.9, -0.1), noise(0.1, 0.1), noise(0.9, -0.1), noise(0.1, 0.1)))
                            elif(s >= 0.6 and s <= 0.8):# if the car is to the right of the track
                                file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(noise(f, 0.1), noise(s, 0.1), noise(j, 0.1), noise(k, 0.1), noise(0.1, 0.1), noise(0.9, -0.1), noise(0.9, -0.1), noise(0.1, 0.1)))
                            else:
                                file.write('%f   %f   %f   %f   %f   %f   %f   %f\n' %(noise(f, 0.1), noise(s, 0.1), noise(j, 0.1), noise(k, 0.1), noise(0.1, 0.1), noise(0.9, -0.1), noise(0.9, -0.1), noise(0.1, 0.1)))
